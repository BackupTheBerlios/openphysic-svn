...
#define LCD_DISP_LENGTH    20     /**< Nombre de caractère visible par ligne */
...
#define LCD_IO_MODE      1         /**< 0: Mode adressage, 1: mode port E/S */
	 ...
	 *
	 */
	#define LCD_PORT         PORTC        /**< Port pour le LCD  			*/
	...
	#define LCD_RS_PORT      PORTB	     /**< Port pour la ligne RS 		*/
	#define LCD_RS_PIN       5            /**< PIN pour la ligne	 		*/
	#define LCD_RW_PORT      PORTB   	  /**< Port pour la ligne RW 		*/
	#define LCD_RW_PIN       6            /**< PIN pour la ligne     		*/
	#define LCD_E_PORT       PORTB   	  /**< Port pour la ligne Enable */
