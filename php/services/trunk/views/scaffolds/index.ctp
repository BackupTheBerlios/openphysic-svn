...
echo $paginator->counter(array(
	'format' => __('Page %page% of %pages%, showing %current% records out of %count% total, starting on record %start%, ending on %end%', true) // scls Patch ToDo
));
?></p>
...
<div class="actions">
	<ul>
		<li><?php echo $html->link(sprintf(__('New %s', true), $singularHumanName), array('action'=>'add')); ?></li> <?php // scls ToDo Patch ?>
<?php
		$done = array();
