...
<div class="actions">
	<ul>
		<li><?php echo $html->link(__('Supprimer', true), array('action'=>'delete', $form->value('Perso.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $form->value('Perso.id'))); ?></li>
