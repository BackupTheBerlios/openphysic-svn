...
\inclure{opt/cours_intro_opt_geom} % conditions de visibilité
...
\inclure{opt/tp_lentilles_minces_conv_foco} % Focométrie lentilles minces
...
\inclure{electromag/tp_champ_magnetique} % Champ magnétique
