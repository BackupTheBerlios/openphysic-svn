...
\item
  \url{http://svn.berlios.de/wsvn/openphysic/doc_classe_latex_phys_ch_pha/trunk/main_dvips_suite_2.pdf} pour le document réduit en 2 pages en 1
\item
  \url{http://svn.berlios.de/wsvn/openphysic/doc_classe_latex_phys_ch_pha/trunk/main.pdf} pour le document non réduit
\end{itemize}
