...
Public Class frmMain
    ...
    Enum Affichage
        ...
        Orientation90Gauche
    End Enum
    Dim mode_affichage As Affichage = Affichage.Normal
    ...
    Private Sub afficher_disque(ByRef g As Graphics, ByVal X As Integer, ByVal Y As Integer, ByVal couleur As Color)
        ...
        g.FillEllipse(brosse, CInt(Int(x1)), CInt(Int(y1)), CInt(x2 - x1), CInt(y2 - y1))
    End Sub
    ...
    Private Sub jeu_vers_pic(ByRef x As Double, ByRef y As Double)
        If mode_affichage = Affichage.Normal Then
            jeu_vers_pic0(x, y)
        Else ' Orientation 90 Droite
            jeu_vers_pic90(x, y)
        End If
    End Sub
    ...
    Private Sub tester_changement_jeu_vers_pic(ByRef g As Graphics)
        ...
        g.DrawLine(stylo, CInt(x1), CInt(y1), CInt(x2), CInt(y2))
        'g.DrawEllipse(stylo,
    End Sub
    ...
    '    mode_affichage = Affichage.Normal
    '    PictureBox1.Refresh()
    'End Sub
    ...
    '    mode_affichage = Affichage.Orientation90Droite
    '    PictureBox1.Refresh()
    'End Sub
