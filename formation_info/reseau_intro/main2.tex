...
\subsection{Qu'est-ce qu'un réseau ?}
 \url{http://fr.wikipedia.org/wiki/Cat%C3%A9gorie:R%C3%A9seau_informatique}
 \url{http://fr.wikipedia.org/wiki/Cat%C3%A9gorie:Protocole_r%C3%A9seau
 \url{http://fr.wikipedia.org/wiki/Topologie_de_r%C3%A9seau}
 \url{http://www.themanualpage.org/reseau/reseau_topo.php}
...
\subsubsection{Adresse IP}
 ...
 \url{http://fr.wikipedia.org/wiki/Protocole_Internet}
 \url{http://fr.wikibooks.org/wiki/Reseaux_TCP/IP_:_adressage_IP_v4}
 \url{http://fr.wikipedia.org/wiki/Adresse_IPv4}
 \url{http://fr.wikipedia.org/wiki/Adresse_IPv6}
