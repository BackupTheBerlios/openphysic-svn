...
;; copier coller à la windows pour Emacs
;; pas pour XEmacs
(pc-selection-mode)

;; déplacement de la fenêtre avec la roulette de la souris pour Emacs
;; pas pour XEmacs
(mouse-wheel-mode)
...
;; Changement de buffer C-x b amélioré pour Emacs
;; pas pour XEmacs
(iswitchb-mode)
...
;; résoud le problème des accents avec aspell et flyspell
