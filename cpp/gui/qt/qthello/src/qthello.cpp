...
qthello::qthello()
    : QMainWindow( 0, "qthello", WDestructiveClose )
{
...
void qthello::load( const QString &fileName )
{
    QFile f( fileName );
...
void qthello::closeEvent( QCloseEvent* ce )
{
    if ( !e->isModified() ) {
	ce->accept();
	return;
